...
/**
 *	\file		lib/reappromultientrepot.lib.php
 *	\ingroup	reappromultientrepot
 *	\brief		This file is an example module library
 *				Put some comments here
 */

function reappromultientrepotAdminPrepareHead()
{
    global $langs, $conf;
    ...
    $head[$h][0] = dol_buildpath("/reappromultientrepot/admin/reappromultientrepot_setup.php", 1);
    $head[$h][1] = $langs->trans("Parameters");
    $head[$h][2] = 'settings';
    $h++;
    $head[$h][0] = dol_buildpath("/reappromultientrepot/admin/reappromultientrepot_about.php", 1);
